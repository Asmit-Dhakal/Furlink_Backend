...
class InitiateEsewaPaymentAPIView(APIView):
	...
	def post(self, request):
		...
		success_url = data.get('success_url') or getattr(settings, 'ESEWA_SUCCESS_URL', 'http://127.0.0.1:8009/payment/success/')
		failure_url = data.get('failure_url') or getattr(settings, 'ESEWA_FAILURE_URL', 'http://127.0.0.1:8009/payment/failure/')
