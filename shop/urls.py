...
from .views import CategoryGetViewSet, ProductGetViewSet, OrderViewSet, CompletedOrderListView
...
urlpatterns = [
    ...
    path('order-list/completed/', CompletedOrderListView.as_view(), name='order-completed'),
